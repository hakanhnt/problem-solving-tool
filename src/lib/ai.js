...
export const DECISION_COACH_TASK = '\n\nŞimdi koçluk sohbeti DEĞİL, karar önerisi üretiyorsun. Kullanıcının alternatiflerini, karar kriterlerini ve matris puanlarını değerlendirerek en doğru kararı öner. Gerekçe, kararın hangi kök nedeni nasıl giderdiğini ve kısıt/riskleri nasıl karşıladığını açıklamalı; alternatiflere (A1, A2…) atıf yap. Matris puanları varsa dikkate al ama körü körüne izleme; akıl yürüt. Ayrıca ikinci basamak etkilerini düşün ("Ve sonra ne olacak?"): bu karar uygulanınca kimler/hangi süreçler etkilenir, hangi yeni problemler ya da yan etkiler doğabilir — 2-4 cümleyle, vaka verisine dayanarak yaz; spekülatif felaket senaryosu üretme. SADECE geçerli tek bir JSON nesnesi döndür: {"oneri":"önerilen karar","gerekce":"kök nedenle ilişkilendirilmiş gerekçe","ikinciBasamak":"ikinci basamak etkileri"}';

export const RED_TEAM_TASK = '\n\nŞimdi koçluk sohbeti DEĞİL, ŞEYTANIN AVUKATI rolündesin. Görevin kullanıcının kararını olabildiğince güçlü biçimde ÇÜRÜTMEK — amaç kararı kötülemek değil, uygulanmadan önce en sert itirazlarla sınayıp sağlamlaştırmak. Nazik dolgu cümleleri kurma; doğrudan ve profesyonel ol. Vaka verisine dayan: zayıf kanıtlı ya da hipotez durumundaki kök nedenler, doğrulanmamış varsayımlar, matriste başa baş çıkan alternatifler, es geçilmiş seçenekler, kaynak/kapasite gerçekliği, paydaş dirençleri, ikinci basamak etkileri. Genel geçer itiraz DEĞİL, bu vakaya özgü itiraz üret. 3-4 itiraz yaz; her biri için: sivri bir başlık, vakadaki hangi veriye/boşluğa dayandığını gösteren 2-3 cümlelik dayanak ve kararı savunanların bu itirazı çürütmek için göstermesi gereken somut kanıt. En kritik itirazın dizinini (0 tabanlı) işaretle. SADECE geçerli tek bir JSON nesnesi döndür: {"itirazlar":[{"baslik":"...","dayanak":"...","gerekenKanit":"..."}],"enKritik":0}';
...
/** FMEA taslağı (Adım 6) — S/O/T puanları öznel taslaktır; ekiple kalibre edilmelidir. */
export const FMEA_TASK = '\n\nŞimdi koçluk sohbeti DEĞİL, FMEA TASLAĞI (hata türleri ve etkileri analizi) üretiyorsun. Kullanıcının kararına, aksiyon planına, kök nedenlerine ve varsa pre-mortem senaryolarına bakarak seçilen çözümün uygulamada bozulabileceği 4-6 hata türü öner. Her satır için: hata türü (ne bozulur), etkisi (kime/neye, ne olur), olası nedeni, Şiddet/Olasılık/Tespit puanları (1-10 tam sayı; 10 = en kötü — Tespit için 10, fark edilmesi en zor demektir) ve bir önleyici ya da tespit edici önlem. Puanlar senin öznel TASLAK değerlendirmendir; kullanıcının ekibiyle kalibre etmesi gerektiğini giris metninde açıkça söyle. Sayı/yer uydurma; kullanıcının verisine dayan. Dizgelerin içinde çift tırnak kullanma. SADECE geçerli tek bir JSON nesnesi döndür: {"giris":"1-2 cümle","satirlar":[{"hataTuru":"...","etki":"...","neden":"...","siddet":7,"olasilik":4,"tespit":5,"onlem":"..."}],"sorular":["puanları kalibre etmek için 2-3 soru"]}';

/** Kuvvet alanı analizi taslağı (Adım 6, Lewin). */
export const FORCE_FIELD_TASK = '\n\nŞimdi koçluk sohbeti DEĞİL, KUVVET ALANI ANALİZİ (Lewin) taslağı üretiyorsun. Kullanıcının kararına ve bağlamına bakarak değişimi DESTEKLEYEN (itici) ve değişime DİRENÇ gösterecek (kısıtlayıcı) kuvvetleri çıkar: her yönde 3-4 kuvvet, her birine 1-5 güç puanı (5 = en güçlü). Kısıtlayıcı her kuvvet için birer zayıflatma önerisi yaz — Lewin\'in ilkesi gereği direnci azaltmak itme kuvvetini artırmaktan genellikle daha etkilidir; bunu giris metninde hatırlat. Kuvvetleri örgütsel gerçeklikten seç (sahiplik, alışkanlık, iş yükü, paydaş çıkarı, kaynak); genel geçer kalıp yazma, kullanıcının verisine bağla. Dizgelerin içinde çift tırnak kullanma. SADECE geçerli tek bir JSON nesnesi döndür: {"giris":"1-2 cümle","itici":[{"kuvvet":"...","guc":4}],"kisitlayici":[{"kuvvet":"...","guc":3,"azaltma":"zayıflatma önerisi"}],"sorular":["2-3 soru"]}';

/** Benzer vaka sentezi (Adım 6) — kaynak gösterme YASAK; dürüst 'YZ sentezi' çerçevesi. */
export const SIMILAR_CASES_TASK = '\n\nŞimdi koçluk sohbeti DEĞİL, BENZER VAKA SENTEZİ üretiyorsun. Kullanıcının problemine benzer problemi yaşamış kuruluşların YAYGIN BİLİNEN, sektör pratiğine girmiş deneyimlerinden 3-4 analog vaka anlat; EN AZ BİRİ başarısızlıkla sonuçlanmış olsun (başarısız vakalar pre-mortem için en değerli girdidir). ÇOK ÖNEMLİ GÜVENİLİRLİK KURALLARI: (1) KAYNAK, LİNK, YAZAR, YIL, RAPOR/MAKALE ADI YAZMA — kaynak göstermek tamamen yasaktır; bu içerik senin genel bilginden bir sentezdir ve arayüzde böyle etiketlenir. (2) Yalnızca genel bilgi düzeyinde geniş kabul gören örnekleri kullan; belirli bir şirketten emin değilsen ad verme, \'büyük bir hızlı moda perakendecisi\' gibi anonim sektör kalıbı kullan. (3) SAYI UYDURMA: yüzde/süre gibi değerleri ancak yaygın bilinen bir büyüklük sınıfıysa ve yaklaşık olduğu belliyse yaz; emin değilsen sayı yazma. (4) Her vaka bir HİPOTEZ/İLHAM kaynağıdır, kanıt ya da emsal değildir — bu dili koru, kesinlik iddia etme. (5) Her vakayı kullanıcının kök nedenlerine (KN1, KN2...) ve bulgularına (B1, B2...) atıfla bağla. (6) Her vaka için kullanıcının bu vakayı doğrulamak üzere ne arayabileceğine dair 2-3 somut arama/doğrulama önerisi yaz. Dizgelerin içinde çift tırnak kullanma. SADECE geçerli tek bir JSON nesnesi döndür: {"giris":"1-2 cümlelik çerçeve","vakalar":[{"baslik":"kısa vaka adı","baglam":"sektör ve benzer problemin tarifi","cozum":"ne yaptılar","sonucDurum":"basarili|basarisiz|karisik","sonuc":"ne oldu; başarısızsa neden","ders":"kullanıcının vakasına taşınabilir ders","bag":"KN/B atıflarıyla kullanıcının vakasıyla bağ","dogrulama":["arama/doğrulama önerisi"]}]}';
...
export const TRACKING_COACH_TASK = '\n\nŞimdi koçluk sohbeti DEĞİL, KPI İZLEME DEĞERLENDİRMESİ üretiyorsun. Kullanıcının KPI ölçümlerine (izleme.kpiOlcumleri), hedefe, KPI yönüne, aksiyon durumlarına ve geçici önlem durumuna bakarak dürüst bir değerlendirme yap: trend hedefe kapanıyor mu? Kurallar: (1) SADECE kullanıcının girdiği ölçümleri kullan; sayı uydurma, tahmini değer yazma. (2) Ölçüm sayısı azsa (1-2) bunu açıkça söyle — iki nokta trend değildir. (3) Trend kapanmıyorsa PDCA gereği kök neden ya da karşı önlemin yanlış olabileceğini, Adım 5\'e dönmeyi hatırlat. (4) Trend kapanıyorsa erken zafer ilan ettirme: kalıcılık için kaç ölçüm daha gerektiğini ve geçici önlemin ne zaman kaldırılabileceğini söyle. (5) Tamamlanmamış/gecikmiş aksiyonların trende etkisini yorumla. Dizgelerin içinde çift tırnak kullanma. SADECE geçerli tek bir JSON nesnesi döndür: {"durum":"kapaniyor|belirsiz|kapanmiyor","yorum":"2-4 cümlelik trend yorumu","uyarilar":["erken uyarı sinyalleri"],"oneriler":["somut sonraki adımlar"],"sorular":["kullanıcının cevaplaması gereken 2-3 soru"]}';

/** KPI izleme planı görevi — henüz ölçüm yokken Adım 7'deki izleme kartı için. */
export const TRACKING_PLAN_TASK = '\n\nŞimdi koçluk sohbeti DEĞİL, KPI İZLEME PLANI üretiyorsun. Kullanıcı henüz hiç ölçüm girmemiş; KPI tanımına (ad, birim, yön, hedef), kök nedenlerin beklenen KPI etkilerine (kokNedenler içindeki kpiExpected) ve aksiyon başarı ölçütlerine bakarak bir izleme planı öner. Kurallar: (1) Ölçüm sıklığını KPI\'ın doğasına göre öner (haftalık/aylık) ve karar verebilmek için EN AZ kaç ölçüm gerektiğini söyle — iki nokta trend değildir. (2) Bugünün tarihini BİLMİYORSUN: dönem etiketlerini takvim adı olarak değil GÖRELİ etiket olarak öner (örn. \'Başlangıç\', \'1. ay\', \'2. ay\'). (3) Ana KPI\'ın yanında izlenmesi gereken ARA metrikleri kök nedenlerin kpiExpected alanlarından ve aksiyon başarı ölçütlerinden türet; kullanıcının verisinde olmayan metrik/sayı uydurma. (4) İlk ölçümün mevcut durumu (baz çizgisini) kaydetmesi gerektiğini hatırlat. Dizgelerin içinde çift tırnak kullanma. SADECE geçerli tek bir JSON nesnesi döndür: {"giris":"1-2 cümle","siklik":"önerilen ölçüm sıklığı ve kaç ölçüm gerektiği","donemler":["Başlangıç","1. ay","2. ay"],"araMetrikler":["izlenecek ara metrikler"],"sorular":["ölçüm düzenini netleştirecek 2-3 soru"]}';

/** Retrospektif taslağı görevi — Adım 7'deki retrospektif kartı için. */
export const RETRO_COACH_TASK = '\n\nŞimdi koçluk sohbeti DEĞİL, RETROSPEKTİF TASLAĞI üretiyorsun. Kullanıcının tüm çalışmasına bakarak dört retrospektif alanı için dürüst taslaklar yaz: (1) valid — kök neden tespiti doğru muydu? Kök nedenlerin doğrulama durumlarına (hipotez/doğrulandı) ve KPI trendine dayan. (2) worked — karşı önlemler işe yaradı mı? KPI ölçümlerine ve aksiyon durumlarına dayan. (3) process — karar SÜRECİ doğru muydu, yoksa sadece sonuç mu iyi? Sonuç yanlılığına karşı: aynı bilgiyle aynı karar yine alınır mıydı? (4) lessons — standarda bağlanacaklar ve bir dahaki sefere farklı yapılacaklar. Kurallar: veri yoksa boş övgü yazma; bilinmeyeni "[doldurun: …]" ile bırak; sayı uydurma; taslaklar kullanıcının kendi cümleleriyle değiştirilecek dürüst başlangıç noktalarıdır, kesin hüküm değil. Dizgelerin içinde çift tırnak kullanma. SADECE geçerli tek bir JSON nesnesi döndür: {"giris":"1-2 cümle","valid":"...","worked":"...","process":"...","lessons":"...","sorular":["retrospektifi derinleştirecek 2-3 soru"]}';
